    ...
    public static void conjugate() {
        ...
        if (MainFragment.verbTense == 0) {
            ...
            if (MainFragment.infinitive.equals("ir")) {
                ...
                MainFragment.conjugationYo = "viera";
                MainFragment.conjugationTu = "vieras";
                MainFragment.conjugationEl = "viera";
                MainFragment.conjugationNos = "viéramos";
                MainFragment.conjugationOs = "vierais";
                MainFragment.conjugationEllos = "vieran";
                MainFragment.setText();
            } else if (MainFragment.infinitive.equals("salir")) {
        ...
        if (MainFragment.verbTense == 0) {
            ...
            if (MainFragment.isEndingAr) {
                ...
                if (MainFragment.infinitive.equals("perder")) {
                    ...
                    MainFragment.setText();
                } else if (MainFragment.infinitive.equals("ejercer")) {
                    MainFragment.conjugationYo = "ejerzo";
                    MainFragment.conjugationTu = "ejerces";
                    MainFragment.conjugationEl = "ejerce";
                    MainFragment.conjugationNos = "ejercemos";
                    MainFragment.conjugationOs = "ejercéis";
                    MainFragment.conjugationEllos = "ejercen";
                    MainFragment.setText();
                } else {
                    // change ending to something else
            ...
            if (MainFragment.isEndingAr) {
                ...
                if (MainFragment.infinitive.equals("perder")) {
                    ...
                    MainFragment.conjugationTu = "ejerce";
                    MainFragment.conjugationEl = "ejerza";
                    MainFragment.conjugationNos = "ejerzamos";
                    MainFragment.conjugationEllos = "ejerzan";
                } else {
                    index = MainFragment.infinitive.lastIndexOf("er");
                    StringBuilder sb = new StringBuilder(MainFragment.infinitive);
                    sb = sb.replace(index, index + 2, "bby");
            ...
            if (MainFragment.isEndingAr) {
                ...
                if (MainFragment.infinitive.equals("perder")) {
                    ...
                    MainFragment.conjugationTu = "no ejerzas";
                    MainFragment.conjugationEl = "no ejerza";
                    MainFragment.conjugationNos = "no ejerzamos";
                    MainFragment.conjugationEllos = "no ejerzan";
                } else {
            ...
            if (MainFragment.isEndingAr) {
                ...
                if (MainFragment.infinitive.equals("perder")) {
                    ...
                    MainFragment.conjugationYo = "ejerza";
                    MainFragment.conjugationTu = "ejerzas";
                    MainFragment.conjugationEl = "ejerza";
                    MainFragment.conjugationNos = "ejerzamos";
                    MainFragment.conjugationOs = "ejerzáis";
                    MainFragment.conjugationEllos = "ejerzan";
                    MainFragment.setText();
                } else {
                    // change ending to something else
